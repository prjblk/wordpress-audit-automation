...
def write_plugins_to_csv_db_and_download(
    csv_filename,
    download_dir,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Download WordPress plugins information, save to a CSV file, insert into a database and optionally download the plugins."
    )
    parser.add_argument(
        "--csv",
        type=str,
        default="output.csv",
        help="The name of the output CSV file (default: output.csv)",
    )
    parser.add_argument(
        "--download-dir",
        type=str,
    ...
    write_plugins_to_csv_db_and_download(
        args.csv, args.download_dir, args.download, args.create_schema, args.verbose
    )
